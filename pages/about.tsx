            ...
            <div className="about">
                <Card style={{ width: '30rem' }}>
                    ...
                    <Card.Body>
                        ...
                        <Card.Text>
                            Zack is the man with the plan.  He led this band of misfits through the battlefield that is Typescript, and he came out the other side a victor.  When given the opportunity, Zack will ALWAYS volunteer as tribute.
                        </Card.Text>
                    </Card.Body>
